...
class SumProperties(
    ...
    @field:JsonPropertyDescription("Minimal allowed 'd' value.")
    val minD: Double = -10.0,
    @field:JsonPropertyDescription("Maximum allowed 'd' value.")
    val maxD: Double = 10.0,
    ...
    val returnTemplate: String = "The sum of %s, %s, %s, and %s is equal to %s.",
